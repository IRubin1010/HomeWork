...
namespace BE
{
    public class Child
    {
        ...
        public int? AgeInMonth { get { if (DateTime.Today.Month - BirthDate.Month == 0) return 0; else return (DateTime.Today.Year - BirthDate.Year) * 12 + DateTime.Today.Month - BirthDate.Month; } set { } }
