...
namespace Pl
{
    ...
    public class Initialize
    {
                ...
                NeedNannyHours = new TimeSpan[2, 6]
     {
            ...
            Mother shimshonYeret = new Mother()
            {
                ID = 294894786,
                LastName = "yeret",
                FirstName = "shimshon",
