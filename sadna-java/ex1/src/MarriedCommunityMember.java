...
public class MarriedCommunityMember extends CommunityMember {
    ...
    public MarriedCommunityMember(int ID, Gender gender, String name, String address, Date birthday, float numOfToraHours, float numOfWorkHours, float salary, float amountGemachUtilization, Volunteering volunteering, int partnerID, int numOfKidsUnder18) throws CommunityExeption {
