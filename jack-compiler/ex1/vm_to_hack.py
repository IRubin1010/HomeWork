            ...
            for line in input_file:
                ...
                if command_length == 1:
                    ...
                    if arithmetic_command == "add":
                        ...
                        output_file.write("\n//eq\n")
                        output_file.write(commands.stuck_compare_arithmetic_command.format(comparer="JEQ",
                                                                                           x=compare_arithmetic_label_counter))
                        compare_arithmetic_label_counter += 1

                    elif arithmetic_command == "gt":
                        output_file.write("\n//gt\n")
                        output_file.write(commands.stuck_compare_arithmetic_command.format(comparer="JGT",
                                                                                           x=compare_arithmetic_label_counter))
                        compare_arithmetic_label_counter += 1

                    elif arithmetic_command == "lt":
                        output_file.write("\n//lt\n")
                        output_file.write(commands.stuck_compare_arithmetic_command.format(comparer="JLT",
                                                                                           x=compare_arithmetic_label_counter))
                        compare_arithmetic_label_counter += 1
