...
class TriangleTests {
	...
	void testFindIntersections() {
        ...
        // 7 points
        Triangle triangle1 = new Triangle(new Point3D(-5,-5,-2),new Point3D(-5,5,-2),new Point3D(5,0,-2), new Color(255,255,255));
        ...
        // 9 points
        Triangle triangle2 = new Triangle(new Point3D(-5,-10,-2),new Point3D(-5,10,-2),new Point3D(5,0,-2), new Color(255,255,255));
        ...
        // 5 points
        Triangle triangle3 = new Triangle(new Point3D(-3,-3,-2),new Point3D(-3,3,-2),new Point3D(5,0,-2), new Color(255,255,255));
        ...
        // 4 points
        Triangle triangle4 = new Triangle(new Point3D(-1.5,-3,-2),new Point3D(-1.5,3,-2),new Point3D(5,0,-2), new Color(255,255,255));
        ...
        // 1 points
        Triangle triangle5 = new Triangle(new Point3D(-0.5,-0.5,-2),new Point3D(-0.5,0.5,-2),new Point3D(0.5,0,-2), new Color(255,255,255));
        ...
        // 0 points
        Triangle triangle6 = new Triangle(new Point3D(-5,-10,2),new Point3D(-5,10,2),new Point3D(5,0,2), new Color(255,255,255));
