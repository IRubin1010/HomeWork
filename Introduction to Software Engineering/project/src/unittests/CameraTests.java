...
public class CameraTests {
	...
	public void testConstructorRayWithScene() {
		...
		scene1.set_distance(100);
		scene2.set_camera(camera);
		scene2.set_distance(10);
		scene3.set_camera(camera);

		// view 3X3
		Ray ray11_3X3 = scene1.get_camera().constructRayThroghPixel(3, 3, 1, 1, 100, 150, 150);
		Ray ray22_3X3 = scene1.get_camera().constructRayThroghPixel(3, 3, 2, 2, 100, 150, 150);
		Ray ray33_3X3 = scene1.get_camera().constructRayThroghPixel(3, 3, 3, 3, 100, 150, 150);
		Ray ray12_3X3 = scene1.get_camera().constructRayThroghPixel(3, 3, 1, 2, 100, 150, 150);
		...
		// view 3X4
		Ray ray11_4X3 = scene1.get_camera().constructRayThroghPixel(4, 3, 1, 1, 10, 12, 15);
		Ray ray22_4X3 = scene1.get_camera().constructRayThroghPixel(4, 3, 2, 2, 10, 12, 15);
		Ray ray14_4X3 = scene1.get_camera().constructRayThroghPixel(4, 3, 1, 4, 10, 12, 15);
		Ray ray23_4X3 = scene1.get_camera().constructRayThroghPixel(4, 3, 2, 3, 10, 12, 15);
		...
		// view 4X4
		Ray ray11_4X4 = scene1.get_camera().constructRayThroghPixel(4, 4, 1, 1, 1, 4, 4);
		Ray ray22_4X4 = scene1.get_camera().constructRayThroghPixel(4, 4, 2, 2, 1, 4, 4);
		Ray ray23_4X4 = scene1.get_camera().constructRayThroghPixel(4, 4, 2, 3, 1, 4, 4);
		Ray ray32_4X4 = scene1.get_camera().constructRayThroghPixel(4, 4, 3, 2, 1, 4, 4);
	...
	public void testconstructorRay() {
		...
		// 3X3
		Ray ray11 = camera1.constructRayThroghPixel(3, 3, 1, 1, 100, 150, 150);
		...
		Ray ray33 = camera1.constructRayThroghPixel(3, 3, 3, 3, 100, 150, 150);
		...
		Ray ray21 = camera1.constructRayThroghPixel(3, 3, 2, 1, 100, 150, 150);
		...
		Ray ray23 = camera1.constructRayThroghPixel(3, 3, 2, 3, 100, 150, 150);
		...
		Ray ray12 = camera1.constructRayThroghPixel(3, 3, 1, 2, 100, 150, 150);
		...
		Ray ray32 = camera1.constructRayThroghPixel(3, 3, 3, 2, 100, 150, 150);
		...
		Ray ray22 = camera1.constructRayThroghPixel(3, 3, 2, 2, 100, 150, 150);
		...
		Ray rayS22 = camera1.constructRayThroghPixel(4, 3, 2, 2, 100, 200, 150);
		...
		Ray rayS32 = camera1.constructRayThroghPixel(4, 3, 3, 2, 100, 200, 150);
		...
		Ray rayS11 = camera1.constructRayThroghPixel(4, 3, 1, 1, 100, 200, 150);
		...
		Ray rayS43 = camera1.constructRayThroghPixel(4, 3, 4, 3, 100, 200, 150);
		...
		Ray ray_c22 = camera1.constructRayThroghPixel(3, 4, 2, 2, 100, 150, 200);
		...
		Ray ray_c32 = camera1.constructRayThroghPixel(3, 4, 3, 2, 100, 150, 200);
		...
		Ray ray_c11 = camera1.constructRayThroghPixel(3, 4, 1, 1, 100, 150, 200);
		...
		Ray ray_c43 = camera1.constructRayThroghPixel(3, 4, 3, 4, 100, 150, 200);
		...
		// 3X3
		Ray ray1 = camera2.constructRayThroghPixel(3, 3, 3, 3, 100, 150, 150);
		...
		// 3X3
		Ray ray_d11 = camera2.constructRayThroghPixel(3, 3, 1, 1, 100, 150, 150);
		...
		Ray ray_d33 = camera2.constructRayThroghPixel(3, 3, 3, 3, 100, 150, 150);
		...
		Ray ray_d21 = camera2.constructRayThroghPixel(3, 3, 2, 1, 100, 150, 150);
		...
		Ray ray_d23 = camera2.constructRayThroghPixel(3, 3, 2, 3, 100, 150, 150);
		...
		Ray ray_d12 = camera2.constructRayThroghPixel(3, 3, 1, 2, 100, 150, 150);
		...
		Ray ray_d32 = camera2.constructRayThroghPixel(3, 3, 3, 2, 100, 150, 150);
		...
		Ray ray_e22 = camera3.constructRayThroghPixel(4, 3, 2, 2, 100, 200, 150);
		...
		Ray ray_e32 = camera3.constructRayThroghPixel(4, 3, 3, 2, 100, 200, 150);
		...
		Ray ray_e11 = camera3.constructRayThroghPixel(4, 3, 1, 1, 100, 200, 150);
		...
		Ray ray_e43 = camera3.constructRayThroghPixel(4, 3, 4, 3, 100, 200, 150);
		...
		Ray littl33 = littlCam.constructRayThroghPixel(3, 3, 3, 3, 10, 6, 6);
		Ray checklittl33 = new Ray(Point3D.ZERO, new Vector(-2, -2, 10).normalize());
		Ray littl11 = littlCam.constructRayThroghPixel(3, 3, 1, 1, 10, 6, 6);
